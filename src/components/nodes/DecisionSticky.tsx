...
export default function DecisionSticky({ data }: any) {
  const width = 168; // 7 * 24px
  const height = 48; // 2 * 24px
  return (
    <div style={{ width, height }} className="rounded-md shadow-soft border">
      <div className="w-full h-full rounded-md" style={{ background: '#fff7b3' }}>
